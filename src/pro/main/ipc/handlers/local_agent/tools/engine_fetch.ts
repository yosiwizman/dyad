/**
 * Shared utility for making fetch requests to the engine API.
...
export const DYAD_ENGINE_URL =
  process.env.DYAD_ENGINE_URL ?? "https://engine.abba.ai/v1";
...
/**
 * Fetch wrapper for engine API calls.
 ...
 * @throws Error if ABBA AI Pro API key is not configured
 */
export async function engineFetch(
  ...
  if (!apiKey) {
    throw new Error("ABBA AI Pro API key is required");
  }
